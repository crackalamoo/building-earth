...
FIELD_INFO: dict[str, dict[str, str]] = {
    "temperature_2m": {"desc": "2-meter air temperature", "unit": "°C"},
    "surface": {"desc": "Surface / SST temperature", "unit": "°C"},
    "boundary_layer": {"desc": "Boundary-layer temperature", "unit": "°C"},
    "atmosphere": {"desc": "Free-atmosphere temperature", "unit": "°C"},
    "albedo": {"desc": "Surface albedo", "unit": "fraction (0-1)"},
    "humidity": {"desc": "Specific humidity", "unit": "kg/kg"},
    "precipitation": {"desc": "Precipitation rate", "unit": "kg/m²/s"},
    "soil_moisture": {"desc": "Soil moisture", "unit": "fraction (0-1)"},
    "wind_u_10m": {"desc": "10-m eastward wind", "unit": "m/s"},
    "wind_v_10m": {"desc": "10-m northward wind", "unit": "m/s"},
    "wind_speed_10m": {"desc": "10-m wind speed", "unit": "m/s"},
    "wind_u": {"desc": "Boundary-layer eastward wind", "unit": "m/s"},
    "wind_v": {"desc": "Boundary-layer northward wind", "unit": "m/s"},
    "wind_speed": {"desc": "Boundary-layer wind speed", "unit": "m/s"},
    "wind_u_geostrophic": {"desc": "Geostrophic eastward wind", "unit": "m/s"},
    "wind_v_geostrophic": {"desc": "Geostrophic northward wind", "unit": "m/s"},
    "wind_speed_geostrophic": {"desc": "Geostrophic wind speed", "unit": "m/s"},
    "ocean_u": {"desc": "Ocean surface eastward current", "unit": "m/s"},
    "ocean_v": {"desc": "Ocean surface northward current", "unit": "m/s"},
    "w_ekman_pumping": {"desc": "Ekman pumping velocity (positive = upwelling)", "unit": "m/s"},
    "cloud_fraction": {"desc": "Total cloud cover", "unit": "fraction (0-1)"},
    "cloud_high": {"desc": "High cloud cover", "unit": "fraction (0-1)"},
    "cloud_low": {"desc": "Low cloud cover", "unit": "fraction (0-1)"},
    "cloud_convective": {"desc": "Convective cloud cover", "unit": "fraction (0-1)"},
    "convective_cloud_frac": {"desc": "Convective cloud fraction", "unit": "fraction (0-1)"},
    "stratiform_cloud_frac": {"desc": "Stratiform cloud fraction", "unit": "fraction (0-1)"},
    "marine_sc_cloud_frac": {"desc": "Marine stratocumulus cloud fraction", "unit": "fraction (0-1)"},
    "high_cloud_frac": {"desc": "High cloud fraction", "unit": "fraction (0-1)"},
    "vertical_velocity": {"desc": "Vertical velocity (positive = rising)", "unit": "m/s"},
    "surface_pressure": {"desc": "Surface pressure", "unit": "Pa"},
    "vegetation_fraction": {"desc": "Vegetation fraction", "unit": "fraction (0-1)"},
    "elevation": {"desc": "Elevation (negative = ocean depth)", "unit": "m"},
}
